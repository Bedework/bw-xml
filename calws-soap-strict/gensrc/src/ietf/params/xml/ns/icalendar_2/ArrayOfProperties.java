...
public class ArrayOfProperties {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "tzid", namespace = "urn:ietf:params:xml:ns:icalendar-2.0", type = JAXBElement.class)
    })
     ...
     * This is why there is not a <CODE>set</CODE> method for the basePropertyOrTzid property.
     * 
     * <p>
